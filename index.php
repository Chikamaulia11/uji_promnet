            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Chika Maulia Apriatin</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    Chika Maulia Apriatin - Web Developer
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="index.php" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Uji Promnet</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
              ...
              <!-- =============== ISI TABEL ADA DI SINI =============== -->
                <table class="table table-striped table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                        <img src="dist/assets/img/<?= $data['cover'] ?>" height="70" width="70" alt="">
                    </td>
                    ...
                    <td>
                      <a href="ubah_data.php?id_buku=<?= $data['id_buku'] ?>" class="btn-sm btn-success btn">Edit</a>
